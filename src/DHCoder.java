...
public class DHCoder {
	...
	public static Map<String, Object> initKey() throws Exception{
		...
		//初始化密钥对生成器
		keyPairGenerator.initialize(KEY_SIZE, null);
		//生成密钥对
		...
		//System.out.println("Alice's public key is: "+publicKey.toString());
		return keyMap;
	}
	...
	public static Map<String, Object> initKey(byte[] key) throws Exception {
		...
		keyMap.put(PUBLIC_KEY, publicKey);
		keyMap.put(PRIVATE_KEY, privateKey);
		//System.out.println("Bob's public key for Alice is: "+pubKey.toString());
		//System.out.println("Bob's public key is: "+publicKey.toString());
		return keyMap;
	}
